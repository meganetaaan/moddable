/*---
description: debug native runtime with counter-like structure.
flags: [async, module]
---*/

import {} from "piu/MC";
import "runtimeBridge";
import { createRef, installNativeDriversFromGlobals, mountPiuApplication, node } from "index";
...
const mounted = mountPiuApplication(() =>
	node(
		...
		node(
			...
			node(
				"row",
				{ left: 24, right: 24, top: 10, height: 48, active: true, skin: buttonSkin, onTap: noop },
