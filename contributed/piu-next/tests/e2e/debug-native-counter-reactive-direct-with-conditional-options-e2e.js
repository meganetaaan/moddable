/*---
description: debug native runtime with counterMain-like conditional options.
flags: [async, module]
---*/
...
const dotX = createComputed(() => (count.value % 9) * 22);
...
const useNativeRuntime = globalThis.__piuNextEnableNativeRuntimeBridge === true;
