import {LIMITS, USER_MEMORY_KEY_PREFIX} from "./constants.js";
...
export function validateNVSKey(key) {
	...
	if (string.length > LIMITS.nvsMaxKeyLength)
		throw new Error(`Error: key max ${LIMITS.nvsMaxKeyLength} chars`);
