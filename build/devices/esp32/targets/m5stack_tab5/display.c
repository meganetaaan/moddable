...
static esp_err_t tab5BoardPrepare(void)
{
	...
	static const uint8_t io1[][2] = {
		{0x03, 0x7F}, {0x05, 0x46}, {0x07, 0x00}, {0x0D, 0x7F}, {0x0B, 0x7F}
	};
	static const uint8_t io2[][2] = {
		{0x03, 0xB9}, {0x07, 0x06}, {0x0D, 0xB9}, {0x0B, 0xF9},
		{0x09, 0x40}, {0x11, 0xBF}, {0x05, 0x89}
	};
	...
	err = tab5WriteRegister(expander1, 0x05, 0x76);
	if (ESP_OK != err)
		goto done;
